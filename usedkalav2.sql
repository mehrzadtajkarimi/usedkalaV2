...
CREATE TABLE `activity_log` (
  ...
  `ip` varchar(16) COLLATE utf8mb4_persian_ci DEFAULT '',
  `type` enum('create','read','update','delete') COLLATE utf8mb4_persian_ci DEFAULT NULL,
  `target_table` varchar(255) COLLATE utf8mb4_persian_ci DEFAULT '',
  `row_id` int(11) DEFAULT 0,
  `where_condition` varchar(500) COLLATE utf8mb4_persian_ci DEFAULT '',
  `detailed_data` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL CHECK (json_valid(`detailed_data`)),
  `uri` varchar(256) COLLATE utf8mb4_persian_ci DEFAULT '',
...
CREATE TABLE `blogs` (
  ...
  `title` varchar(500) COLLATE utf8mb4_persian_ci DEFAULT NULL,
...
CREATE TABLE `brands` (
  `id` int(11) NOT NULL,
  `name` varchar(100) COLLATE utf8mb4_persian_ci NOT NULL,
  `slug` varchar(255) COLLATE utf8mb4_persian_ci DEFAULT '',
  `html_title` varchar(500) COLLATE utf8mb4_persian_ci DEFAULT '',
  `html_desc` text COLLATE utf8mb4_persian_ci DEFAULT NULL,
  `canonical` varchar(500) COLLATE utf8mb4_persian_ci DEFAULT '',
...
CREATE TABLE `categories` (
  ...
  `name` varchar(100) COLLATE utf8mb4_persian_ci NOT NULL,
  `slug` varchar(100) COLLATE utf8mb4_persian_ci DEFAULT '',
...
CREATE TABLE `coupons` (
  ...
  `user_id` int(11) NOT NULL,
  `user_level` tinyint(4) NOT NULL COMMENT '1=Bronze 2=Silver 3=Gold 4=Platinum 5=Titanium',
...
CREATE TABLE `orders` (
  ...
  `token` varchar(100) COLLATE utf8mb4_persian_ci DEFAULT NULL,
...
CREATE TABLE `products` (
  ...
  `user_id` int(11) DEFAULT 0,
  `title` varchar(100) COLLATE utf8mb4_persian_ci DEFAULT '',
  `title_english` varchar(500) COLLATE utf8mb4_persian_ci DEFAULT '',
  ...
  `slug` varchar(256) COLLATE utf8mb4_persian_ci DEFAULT '',
...
CREATE TABLE `relateds` (
  `id` int(11) NOT NULL,
  `entity_type` varchar(255) COLLATE utf8mb4_persian_ci NOT NULL,
...
CREATE TABLE `samples` (
  `id` int(11) NOT NULL,
  `title` varchar(128) COLLATE utf8mb4_persian_ci DEFAULT NULL,
  `user_id` int(11) DEFAULT NULL,
  `code` varchar(128) COLLATE utf8mb4_persian_ci DEFAULT NULL,
  `type` tinyint(4) DEFAULT NULL,
  `percent` tinyint(4) DEFAULT NULL COMMENT '%',
  `description` varchar(512) COLLATE utf8mb4_persian_ci DEFAULT NULL,
  `status` tinyint(1) DEFAULT 1,
  `start_price` int(11) DEFAULT NULL,
  `finish_price` int(11) DEFAULT NULL,
...
CREATE TABLE `users` (
  ...
  `city_id` int(10) UNSIGNED DEFAULT NULL,
  `province_id` int(10) UNSIGNED DEFAULT NULL,
  `user_level` tinyint(4) DEFAULT 1 COMMENT '0=Admin 1=Bronze 2=Silver 3=Gold 4=Platinum 5=Titanium',
  `phone` varchar(100) COLLATE utf8mb4_persian_ci NOT NULL,
  `email` varchar(500) COLLATE utf8mb4_persian_ci DEFAULT NULL,
