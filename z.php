	...
	<div class="col-full">
		<div class="row">
			<nav class="woocommerce-breadcrumb">
				...
				<?php
				$query=mysqli_query($CON,"SELECT * FROM `core_cats_rels` as rels INNER JOIN `core_cats` as cats ON rels.`catID` = cats.`ID_cats` WHERE rels.`db_id_cats_rels` = '".$Row['ID_products']."' AND rels.`db_cats_rels` = 'mod_products'");
				$row=mysqli_fetch_assoc($query);
				?>
				<a href="<?= $GLOBALS['rootPath']."category/".$row['escaped_title_cats'] ?>"><?= $row['title_cats'] ?></a>
				<span class="delimiter">
					<i class="fa fa-arrow-left"></i>
				</span><?= $Row['field0'] ?>
			</nav>
			...
			<div id="primary" class="content-area">
				<main id="main" class="site-main">
					<div class="product product-type-simple">
						<div class="single-product-wrapper">
								...
								<div id="techmarket-single-product-gallery" class="techmarket-single-product-gallery techmarket-single-product-gallery--with-images techmarket-single-product-gallery--columns-4 images" data-columns="4">
									<div class="techmarket-single-product-gallery-images" data-ride="tm-slick-carousel" data-wrap=".woocommerce-product-gallery__wrapper" data-slick="{&quot;infinite&quot;:false,&quot;slidesToShow&quot;:1,&quot;slidesToScroll&quot;:1,&quot;dots&quot;:false,&quot;arrows&quot;:false,&quot;asNavFor&quot;:&quot;#techmarket-single-product-gallery .techmarket-single-product-gallery-thumbnails__wrapper&quot;}">
										<div class="woocommerce-product-gallery woocommerce-product-gallery--with-images woocommerce-product-gallery--columns-4 images" data-columns="4">
											...
											<figure class="woocommerce-product-gallery__wrapper ">
												...
												$count=0;
												$thumbnails=[];
												$queryStr="SELECT * FROM `core_imagealbums` WHERE `db_imagealbums` = 'products' AND `db_id_imagealbums` = '$Row[ID_products]' AND `field_id_imagealbums` = 7 AND `published_imagealbums` = 1 ORDER BY `sort_imagealbums` DESC";
												// die($queryStr);
												...
												while ($row=mysqli_fetch_assoc($query))
												{
													...
													array_push($thumbnails,$GLOBALS['rootPath']."uploads/".mb_substr($row['filename'],0,-4,'utf-8')."_thumb".mb_substr($row['filename'],-4,4,'utf-8'));
												?>
												<div data-thumb="<?= $GLOBALS['rootPath'] ?>uploads/<?= mb_substr($row['filename'],0,-4,'utf-8')."_thumb".mb_substr($row['filename'],-4,4,'utf-8') ?>" class="woocommerce-product-gallery__image">
													<a href="<?= $GLOBALS['rootPath'] ?>uploads/<?= $row['filename'] ?>" target="_blank" tabindex="<?= $tabIndexStr ?>">
														<img width="600" height="600" src="<?= $GLOBALS['rootPath'] ?>uploads/<?= mb_substr($row['filename'],0,-4,'utf-8')."_croped".mb_substr($row['filename'],-4,4,'utf-8') ?>" class="attachment-shop_single size-shop_single <?= $classStr ?>" alt="">
													</a>
												</div>
												<?php
												}
									...
									<div class="techmarket-single-product-gallery-thumbnails" style="position: absolute;right: 0;" data-ride="tm-slick-carousel" data-wrap=".techmarket-single-product-gallery-thumbnails__wrapper" data-slick="{&quot;infinite&quot;:false,&quot;slidesToShow&quot;:4,&quot;slidesToScroll&quot;:1,&quot;dots&quot;:false,&quot;arrows&quot;:true,&quot;vertical&quot;:true,&quot;verticalSwiping&quot;:true,&quot;focusOnSelect&quot;:true,&quot;touchMove&quot;:true,&quot;asNavFor&quot;:&quot;#techmarket-single-product-gallery .woocommerce-product-gallery__wrapper&quot;,&quot;responsive&quot;:[{&quot;breakpoint&quot;:765,&quot;settings&quot;:{&quot;vertical&quot;:false,&quot;horizontal&quot;:true,&quot;verticalSwiping&quot;:false,&quot;slidesToShow&quot;:4}}]}">
										<figure class="techmarket-single-product-gallery-thumbnails__wrapper">
											<?php
											foreach (array_reverse($thumbnails) as $i=>$thumbnail)
											{
												if ($i==0)
												{
													$classStr="wp-post-image";
											...
											?>
											<figure data-thumb="<?= $thumbnail ?>" class="techmarket-wc-product-gallery__image">
												<img width="180" height="180" src="<?= $thumbnail ?>" class="attachment-shop_thumbnail size-shop_thumbnail <?= $classStr ?>" alt="">
											</figure>
											<?php
											}
											?>
							...
							<div class="summary entry-summary">
								<div class="single-product-header">
									<h1 class="product_title entry-title"><?= $Row['field0'] ?></h1>
									<h2 class="product_title entry-title"><?= $Row['field10'] ?></h2>
									<a class="add-to-wishlist" href="javascript:void(0)"> افزودن به علاقه مندی ها</a>
								</div>
								...
								<div class="rating-and-sharing-wrapper">
									<div class="woocommerce-product-rating">
										<div class="star-rating">
											<span style="width:100%">امتیاز
												<strong class="rating">5.00</strong> از 5 امتیاز برساس
												<span class="rating">1</span> خریدار </span>
										</div>
										<a rel="nofollow" class="woocommerce-review-link" href="#reviews">(<span
												class="count">1</span> نظر مشتری)</a>
									</div>
								</div>
								...
								<div class="product-actions-wrapper">
									<div class="product-actions">
										<p class="price" dir="rtl">
											<?php
											if ($Row['field6']!=0 && $Row['field6']<$Row['field5'])
											{
											?>
											<del>
												<span class="woocommerce-Price-amount amount"><?= replaceAll(number_format($Row['field5'])) ?> ریال</span>
											</del>
											<ins>
												<span class="woocommerce-Price-amount amount"><?= replaceAll(number_format($Row['field6'])) ?> ریال</span>
											</ins>
											<?php
											}
											else
										...
										<form action="javascript:add_to_cart(<?= $Row['ID_products'] ?>,$('#quantity-input').val())" class="cart">
											<div class="quantity">
												<label for="quantity-input">تعداد</label>
												<input type="number" size="4" class="input-text qty text" title="Qty" value="1" id="quantity-input">
											</div>
											<!-- .quantity -->
											<button class="single_add_to_cart_button button alt" value="185" name="add-to-cart" type="submit">افزودن به سبد خرید</button>
										</form>
										
										<a class="add-to-compare-link" href="javascript:void(0)">مقایسه</a>
									</div>
									<!-- .product-actions -->
								</div>
						...
						<?php /*
						<div dir="ltr" class="tm-related-products-carousel section-products-carousel" id="tm-related-products-carousel" data-ride="tm-slick-carousel" data-wrap=".products" data-slick="{&quot;slidesToShow&quot;:7,&quot;slidesToScroll&quot;:7,&quot;dots&quot;:true,&quot;arrows&quot;:true,&quot;appendArrows&quot;:&quot;#tm-related-products-carousel .custom-slick-nav&quot;,&quot;responsive&quot;:[{&quot;breakpoint&quot;:767,&quot;settings&quot;:{&quot;slidesToShow&quot;:1,&quot;slidesToScroll&quot;:1}},{&quot;breakpoint&quot;:780,&quot;settings&quot;:{&quot;slidesToShow&quot;:3,&quot;slidesToScroll&quot;:3}},{&quot;breakpoint&quot;:1200,&quot;settings&quot;:{&quot;slidesToShow&quot;:4,&quot;slidesToScroll&quot;:4}},{&quot;breakpoint&quot;:1400,&quot;settings&quot;:{&quot;slidesToShow&quot;:5,&quot;slidesToScroll&quot;:5}}]}">
							<section class="related">
								<header class="section-header" dir="rtl">
								...
								<div class="products">
									<div class="product">
										...
										<a href="single-product-fullwidth.html"
											...
											<span class="price" dir="rtl">
												<ins>
													<span class="amount">1000 ریال </span>
												</ins>
											</span>
											<!-- /.price -->
										...
										<div class="hover-area">
											...
											<a class="add-to-compare-link" href="compare.html">مقایسه کردن</a>
										</div>
									</div>
									<!-- /.product-outer -->
									<div class="product">
										...
										<a href="single-product-fullwidth.html"
											...
											<span class="price" dir="rtl">
												...
												<span class="amount"> 2620000000 ریال</span>
											</span>
											<!-- /.price -->
									...
									<div class="product">
										...
										<a href="single-product-fullwidth.html"
											...
											<span class="price" dir="rtl">
												...
												<span class="amount"> 4560000000 ریال</span>
											</span>
											<!-- /.price -->
									...
									<div class="product">
										...
										<a href="single-product-fullwidth.html"
											...
											<span class="price" dir="rtl">
												...
												<span class="amount"> 45600000 ریال</span>
											</span>
											<!-- /.price -->
									...
									<div class="product">
										...
										<a href="single-product-fullwidth.html"
											...
											<span class="price" dir="rtl">
												...
												<span class="amount"> 399000000 ریال</span>
											</span>
											<!-- /.price -->
											<h2 class="woocommerce-loop-product__title">Band Fitbit Flex</h2>
										</a>
									...
									<div class="product">
										...
										<a href="single-product-fullwidth.html"
											class="woocommerce-LoopProduct-link">
											<span class="onsale" dir="rtl">
												<span class="woocommerce-Price-amount amount">150000000 ریال</span>
											</span>
											<img src="assets/images/products/14.jpg" width="224" height="197"
												class="wp-post-image" alt="">
											<span class="price" dir="rtl">
												<ins>
													<span class="amount"> 26900000 ریال</span>
												</ins>
												<del>
													<span class="amount">39900000 ریال</span>
												</del>
												<span class="amount"> </span>
											</span>
											<!-- /.price -->
									...
									<div class="product">
										...
										<a href="single-product-fullwidth.html"
											class="woocommerce-LoopProduct-link">
											<span class="onsale" dir="rtl">
												<span class="woocommerce-Price-amount amount">15000000 ریال</span>
											</span>
											<img src="assets/images/products/2.jpg" width="224" height="197"
												class="wp-post-image" alt="">
											<span class="price" dir="rtl">
												<ins>
													<span class="amount" dir="rtl"> 309950000 ریال</span>
												</ins>
												<br>
												<del>
													<span class="amount" dir="rtl">4590000000 ریال</span>
												</del>
												<span class="amount"> </span>
											</span>
											<!-- /.price -->
									...
									<div class="product">
										...
										<a href="single-product-fullwidth.html"
											...
											<span class="price" dir="rtl">
												<ins>
													<span class="amount"> 78995000 ریال</span>
												</ins>
												<del>
													<span class="amount">999000000 ریال</span>
												</del>
												<span class="amount"> </span>
											</span>
											<!-- /.price -->
									...
									<div class="product">
										...
										<a href="single-product-fullwidth.html"
											...
											<span class="price" dir="rtl">
												...
												<span class="amount"> 456000000 ریال</span>
											</span>
											<!-- /.price -->
						...
						*/ ?>
						...
						<div class="woocommerce-tabs wc-tabs-wrapper">
							<ul role="tablist" class="nav tabs wc-tabs">
								<!--li class="nav-item accessories_tab">
									<a class="nav-link active" data-toggle="tab" role="tab" aria-controls="tab-accessories" href="#tab-accessories">لوازمات جانبی</a>
								</li-->
								<li class="nav-item description_tab">
									<a class="nav-link" data-toggle="tab" role="tab" aria-controls="tab-description" href="#tab-description">معرفی محصول</a>
								</li>
								<!--li class="nav-item specification_tab">
									<a class="nav-link" data-toggle="tab" role="tab" aria-controls="tab-specification" href="#tab-specification">ویژگی ها</a>
								</li-->
								<!--li class="nav-item reviews_tab">
									<a class="nav-link" data-toggle="tab" role="tab" aria-controls="tab-reviews" href="#tab-reviews">دیدگاه ها (1)</a>
								</li-->
							</ul>
							<!-- /.ec-tabs -->
													...
													<div class="product">
														<a class="woocommerce-LoopProduct-link woocommerce-loop-product__link"
															...
															<span class="price" dir="rtl">
																<del>
																	<span
																		class="woocommerce-Price-amount amount">1239990000 ریال</span>
																</del>
																<ins>
																	<span
																		class="woocommerce-Price-amount amount">997000000 ریال</span>
																</ins>
															</span>
														...
														<div class="checkbox accessory-checkbox">
															<label>
																<input type="checkbox"
																	...
																	class="product-check" checked=""> حذف
															</label>
														</div>
													</div>
													<div class="product">
											...
											<div class="accessories-product-total-price">
												<div class="total-price">
													<span class="total-price-html price">
														<span class="woocommerce-Price-amount amount">16669400000 ریال
														</span>
													</span>
													<!-- .total-price-html -->
													<span>مجموع قیمت لاوازمات جانبی</span>
												</div>
												<!-- .total-price -->
												<div class="accessories-add-all-to-cart">
													<button class="button btn btn-primary add-all-to-cart"
														type="button">افزودن به سبد خرید</button>
												</div>
								...
								*/ ?>
								...
								<div class="tab-pane" id="tab-specification" role="tabpanel">
									<div class="tm-shop-attributes-detail like-column columns-3">
										<h3 class="tm-attributes-title">مشخصات کلی</h3>
										<table class="shop_attributes">
											<tbody>
												<tr>
													<th>برند سازنده</th>
													<td>
														<p><a href="#" rel="tag">Cisco</a></p>
													</td>
												</tr>
												<tr>
													<th>لیبل</th>
										...
										<!-- /.shop_attributes -->
										<h3 class="tm-attributes-title">ویژگی های محصول</h3>
										<table class="shop_attributes">
											<tbody>
												<tr>
													<th>ابعاد</th>
									...
									<div class="techmarket-advanced-reviews" id="reviews">
										<div class="advanced-review row">
											<div class="advanced-review-rating">
												<h2 class="based-title">دیدگاه (1)</h2>
												...
												<div id="review_form_wrapper">
													<div id="review_form">
														<div class="comment-respond" id="respond">
															<h3 class="comment-reply-title" id="reply-title">دیدگاهتان را بیان کنید</h3>
												...
												<li id="li-comment-83"
													...
													<div class="comment_container" id="comment-83">
														<div class="comment-text">
															<div class="star-rating">
																<span style="width:100%">امتیاز
																	<strong class="rating">5</strong> از
																	5</span>
															</div>
															<p class="meta">
																<strong itemprop="author"
																	class="woocommerce-review__author">محمد
																	محمدی</strong>
																<span
																	class="woocommerce-review__dash">&ndash;</span>
																<time datetime="2017-06-21T08:05:40+00:00"
																	itemprop="datePublished"
																	class="woocommerce-review__published-date">11 آبان 1397</time>
															</p>
															<div class="description">
																<p>محصولات شما بی نظیر هستند</p>
															</div>
															<!-- /.description -->
														</div>
														<!-- /.comment-text -->
						...
						<section class="section-landscape-products-carousel recently-viewed"
							...
							<header class="section-header">
								<h2 class="section-title">محصولات مشاهده شده</h2>
								<nav class="custom-slick-nav"></nav>
							</header>
							<div class="products-carousel" data-ride="tm-slick-carousel" data-wrap=".products"
								data-slick='{"rtl":true, "slidesToShow":5,"slidesToScroll":2,"dots":true,"arrows":true,"prevArrow":"<a href=\"#\"><i class=\"tm tm-arrow-right\"><\/i><\/a>","nextArrow":"<a href=\"#\"><i class=\"tm tm-arrow-left\"><\/i><\/a>","appendArrows":"#recently-viewed .custom-slick-nav","responsive":[{"breakpoint":992,"settings":{"slidesToShow":2,"slidesToScroll":2}},{"breakpoint":1200,"settings":{"slidesToShow":3,"slidesToScroll":3}},{"breakpoint":1400,"settings":{"slidesToShow":3,"slidesToScroll":3}},{"breakpoint":1700,"settings":{"slidesToShow":4,"slidesToScroll":4}}]}'>
															...
															<span class="price" dir="rtl">
																<ins>
																	<span class="amount" dircetion="rtl">
																		66.000.000 ریال</span>
																</ins>
																<br>
																<del>
																	<span class="amount"
																		dircetion="rtl">74.000.000 ریال</span>
																</del>
													...
													<div class="media">
														...
														<div class="media-body" style="direction: rtl;">
															<span class="price" dir="rtl">
																...
																<span class="amount" dircetion="rtl">500.000.000
																	ریال</span>
															</span>
															<!-- .price -->
													...
													<div class="media">
														...
														<div class="media-body" style="direction: rtl;">
															<span class="price" dir="rtl">
																...
																<span class="amount" dircetion="rtl"> 80.000.000
																	ریال</span>
															</span>
															<!-- .price -->
