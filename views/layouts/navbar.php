<nav id="primary-navigation" class="primary-navigation" aria-label="Primary Navigation" data-nav="flex-menu">
    ...
    <ul id="menu-primary-menu" class="nav yamm">
        ...
        <li class="menu-item menu-item-has-children animate-dropdown dropdown show">
            <a title="درباره ما" data-toggle="dropdown" aria-haspopup="true" class="dropdown-toggle" href="https://usedkala.com/about" aria-expanded="true">درباره ما<span class="caret"></span></a>
