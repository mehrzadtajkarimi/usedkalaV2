<div class="card ">
  <div class="p-0 shadow-sm card-body">
    <div class="card-header">
      <div class="row">
        <div class="col-4">
          <h3 class="p-3 card-title"> لیست سفارشات</h3>
        </div>
        ...
        <div class="col-4">
          <div class="input-group input-group-sm">
            ...
            <a href="<?= base_url() ?>admin/cart/create" type="button" class="mr-2 shadow-sm btn btn-success " data-toggle="modal" data-target="#exampleModalCenter">
              ایجاد سفارش
            </a>
            <!-- Modal -->
              ...
              <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                <div class="modal-content">
                  <div class="modal-body">
                    <form action="<?= base_url() ?>admin/cart" method="post" class="p-1">
                      ...
                      <div class="row">
                        <div class="col">
                          <div class="form-group ">
                            <label for="cart-title">موضوع</label>
                      ...
                      <div class="row">
                        <div class="col">
                          <div class="form-group ">
                            <label for="cart-percent">میزان تخفیف %</label>
                            <input name="cart-percent" type="text" maxlength="3" class="form-control" id="cart-percent" placeholder="" required>
                          </div>
                        </div>
                      </div>
                      <div class="col">
                      ...
                      <div class="form-group">
                        <label for="cart-description" class="col-form-label"> توضیحات</label>
                        <textarea name="cart-description" type="text" class="form-control" id="cart-description" placeholder="" rows="2" required></textarea>
                      </div>
