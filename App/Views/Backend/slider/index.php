                    ...
                    <form action="<?= base_url() ?>admin/slider" method="post" class="p-1" enctype="multipart/form-data">
                      ...
                      <div class="row">
                        ...
                        <div class="col">
                          ...
                          <select name="product_id" id="slider_product" class="form-control select2 select2-hidden-accessible" style="width: 100%;text-align: right" multiple="multiple" disabled>
