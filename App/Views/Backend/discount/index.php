              ...
              ?>
                <tr>
                  ...
                  <td class="text-center">
                      <i class="fa fa-folder-open fa-2x text-muted btn_show_discant" data-id="<?= $value['id'] ?>" aria-hidden="true"></i>
                  </td>
                  <td class="text-center ">
                ...
                <tr>
                  <td colspan="10" class=" show_discant_<?= $value['id'] ?> " style="display: none">
    ...
    <nav aria-label="Page navigation example">
      <ul class="pagination justify-content-center">
        ...
        <li class="page-item <?php if (pagination_count('discounts', 10) + 1 == 1 || (isset($_GET['page']) &&  pagination_count('discounts', 10) + 1  == $_GET['page'])) echo "disabled" ?>">
          <a class="page-link" href="<?= base_url() ?>admin/discount?page=<?php if (isset($_GET['page'])) echo $_GET['page'] + 1;
