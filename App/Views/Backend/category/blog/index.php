              ...
              <li class="list-group-item  <?= $value['parent'] == 0 ? 'bg-light font-weight-bold mt-3' : '' ?>">
                <div class="row">
                  ...
                  <div class="col">
                    ...
                    <a href="<?= base_url() ?>admin/category/<?= $value['id'] ?>/create/blog" class="btn btn-success btn-sm shadow-sm" style="padding: 0px 20px; border-radius: 18px;">ایجاد زیردسته</a>
...
<?php include(BASEPATH . "/App/Views/Backend/category/blog/script.php") ?>