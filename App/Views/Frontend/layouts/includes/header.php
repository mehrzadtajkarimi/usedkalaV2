                                                            ...
                                                            <?php foreach ($categoryLevelTwo[$valueLevelOne['id']] as $valueLevelTwo) : ?>
                                                                <?php if ($valueLevelTwo['status'] == 1) : ?>
                                                                    <div class="ml-3 mr-3 col ">
                                                                        <ul>
                                                                            <li class="">
                                                                                <a class="text-center d-flex justify-content-center" href="<?= base_url() ?>category/<?= $valueLevelTwo['slug'] ?>">
                                                                                    <div class="border-0 card " style="width: 10rem;">
                                                                                        <img class="card-img-top img-fluid uksquareimg" src="<?= $valueLevelTwo['path'] ?? '' ?>" alt="<?= $valueLevelTwo['alt'] ?? '' ?>">
