                                    ...
                                    <?php foreach ($products as $value) : ?>
                                        <div class="product first">
                                            <div class="yith-wcwl-add-to-wishlist">
                                                <a href="#" rel="nofollow" class="add_to_wishlist <?php if (in_array($value['id'], $selected_wishlist)) echo 'active'; ?>" data-id="<?= $value['id'] ?>" data-type="Product"> افزودن به علاقه‌مندی‌ها</a>
                                            </div>
